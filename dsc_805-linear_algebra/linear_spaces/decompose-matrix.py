...
print(f"Column Space (basis) shape: {col_space_basis}")
print(f"\nRow Space (basis) shape: {row_space_basis}")
print(f"\nNull Space (basis) shape: {nullspace_basis}")
print(f"\nLeft Null Space (basis) shape: {left_nullspace_basis}")
print("\nRank-Nullity Theorem Verification:")
